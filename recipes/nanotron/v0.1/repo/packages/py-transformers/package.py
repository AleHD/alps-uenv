...
class PyTransformers(PythonPackage):
    ...
    version("4.40.1", sha256="55e1697e6f18b58273e7117bb469cdffc11be28995462d8d5e422fef38d2de36")
    ...
    depends_on("py-tokenizers@0.14:0.18", when="@4.35:4.34", type=("build", "run"))
